...
module.exports = {
  types: [
    ...
    {
      value: 'style',
      name: 'style:     コードスタイルの変更 (コードの動作に影響しないスペース、フォーマット、セミコロンなどの変更)',
      title: 'Styles'
    },
    {
      value: 'refactor',
    ...
    {
      value: 'build',
      name: 'build:     ビルドシステムや外部依存に関する変更 (スコープ例: gulp, broccoli, npm)',
      title: 'Builds'
    },
    {
      value: 'ci',
      name: 'ci:       CI用の設定やスクリプトに関する変更 (スコープ例:Travis, Circle, BrowserStack, SauceLabs)',
      title: 'CI'
    },
    {
      value: 'chore',
      name: 'chore:    カテゴライズする必要がないその他の変更 (補助ツール、ドキュメント生成などのソースやテストの変更を含まない変更)',
      title: 'Chores'
    },
    {
      value: 'wip',
